  ...
  <div className="section-inner">
    <div className="why-grid">
      <div>
        ...
        <h2 className="section-title reveal reveal-delay-1">The <span className="gold">Standard</span> of<br /><span className="italic">Corporate Excellence</span></h2>
      ...
      <div className="why-right">
        ...
        <div className="why-metrics reveal reveal-delay-1">
          <div className="metric">
            ...
            <span className="metric-label">Cases Resolved</span>
          </div>
          <div className="metric">
